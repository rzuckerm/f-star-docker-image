F-STAR_VERSION := $(shell cat F-STAR_VERSION)
F-STAR_DEPS := $(wildcard F-STAR_*)
DOCKER_TAG_PREFIX := rzuckerm/f-star:$(F-STAR_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(F-STAR_DEPS)
